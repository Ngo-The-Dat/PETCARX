...
BEGIN
    INSERT INTO CTHDSANPHAM
        (MAHD, MASP, SOLUONG, DONGIAHIENTAI)
    VALUES
        (@MAHD, @MASP, @SOLUONG, @DONGIAHIENTAI)
END
GO

CREATE OR ALTER PROCEDURE sp_CreateDetailInvoice_Service
    @MAHD INT,
    @MADV INT,
    @MATC INT,
    @DONGIAHIENTAI DECIMAL(18,2)
...
GO
=======
>>>>>>> 3320bb93db8ffae8721db9adb5d5ac9c897e7eab
