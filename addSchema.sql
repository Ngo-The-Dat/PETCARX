...
ALTER TABLE CTHDSANPHAM
DROP CONSTRAINT FK_CTHDSANPHAM_MAHD

ALTER TABLE CTHDDV
DROP CONSTRAINT FK_CTHDDV_MAHD
GO
...
ALTER TABLE HOADON
ADD CONSTRAINT PK_HOADON PRIMARY KEY NONCLUSTERED(MAHD)

ALTER TABLE CTHDSANPHAM
ADD CONSTRAINT FK_CTHDSANPHAM_MAHD FOREIGN KEY(MAHD) REFERENCES HOADON(MAHD)

ALTER TABLE CTHDDV
ADD CONSTRAINT FK_CTHDDV_MAHD FOREIGN KEY(MAHD) REFERENCES HOADON(MAHD)
