...
CREATE CLUSTERED INDEX INDEX_TAIKHOANHOIVIEN_CAPBAC
...
CREATE NONCLUSTERED INDEX INDEX_TAIKHOANHOIVIEN_SDT
ON TAIKHOANHOIVIEN(SDT)
GO

CREATE NONCLUSTERED INDEX IDX_HOADON_MATK
ON HOADON(MATK)
GO

CREATE NONCLUSTERED INDEX IDX_HOSOKHAMBENH_MATC
ON HOSOKHAMBENH(MATC)
GO

CREATE INDEX INDEX_HOSOKHAMBENH_MATC
ON HOSOKHAMBENH(MATC)
GO

CREATE NONCLUSTERED INDEX IDX_HOSOKHAMBENH_MABACSI
ON HOSOKHAMBENH(MABACSI)
GO

CREATE INDEX INDEX_HOSOTIEMPHONG_MATC_NGAY
ON HOSOTIEMPHONG (MATC, NGAYTIEM)
GO

CREATE NONCLUSTERED INDEX IDX_HOSOTIEMPHONG_MATC
ON HOSOTIEMPHONG(MATC)
GO

CREATE NONCLUSTERED INDEX IDX_HOSOTIEMPHONG_MABACSI
ON HOSOTIEMPHONG(MABACSI)
GO

CREATE NONCLUSTERED INDEX IDX_SANPHAM_TEN
ON SANPHAM(TEN)
GO
